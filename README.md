...
1. moverse a la carpeta de backend y ejecutar los suguientes comandos
    ...
    . npm install
    . npm run seed
2. moverse a la carpeta de frontend y ejecutar npm install
3. volver a la carpeta raiz TP-DDS-final
4. ejecutar .\start-dev.cmd
5. si se quiere cargar la semilla hay que moverse a la carpeta de back y ejecutar npm run seed
6. aca abajo se encuentran otras opciones de arranque pero esta es la ultima funcional y recomendada.
...
```powershell
cd "C:\Users\marti\Desktop\facu\3er año\DDS\TP-PRE-PARCIAL\TP-COMPLETO\TP-DDS-completo\TP-DDS-completo"
.\start-dev.cmd
```
...
Para probar el script sin abrir ventanas ni levantar servicios:
